...
//! into `autopool` with the `tuning` flag in order to help debug and tune
//! your PID controllers.
//!
//! ```toml
//! [dependencies.autopool]
//! version = "0.1.0"
//! features = ["tuning"]
//! ```
//!
//! This is also used by the `autopool` test and example suite, and is a
...
/// ```
/// use autopool::PidController;
/// use autopool::tuning::{setup_logger, filter_log};
/// use log::LevelFilter;
///
/// setup_logger(LevelFilter::Debug, "simple.log".into()).unwrap();
/// // ... do stuff!
/// filter_log("simple.log".into(), "clobber::pid", "some_smaller.log").expect("Failed to graph");
/// ```
///
/// Check out the format below for what it's expecting if you want add your own lines to gnuplot.
